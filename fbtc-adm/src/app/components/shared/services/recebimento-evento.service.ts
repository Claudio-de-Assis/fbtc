...
@Injectable()
export class RecebimentoEventoService {
    ...
    addRecebimentoEvento (recebimento: Recebimento): Observable<Recebimento> {
    ...
    */
    ...
    private log(message: string) {
        this.messageService.add('RecebimentoEventoService: ' + message);
    }
    ...
    getRecebimentoAnuidadeNo404<Data>(id: number): Observable<Recebimento> {
        ...
        .pipe(
            ...
            catchError(this.handleError<Recebimento>(`getRecebimentoEvento id=${id}`))
        );
    }
